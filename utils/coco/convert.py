...
def convert_wider_to_coco(wider_dir_annotations: str):
    coco_annotations = {"images": [], "annotations": [], "categories": []}
    categories = {}
    
    for ann_name in tqdm(os.listdir(wider_dir_annotations)):
        ann_path = osp.join(wider_dir_annotations, ann_name)
        ...
        for ann_obj in ann_data["objects"]:        
            categories.update({ann_obj['classTitle']: len(categories)})
